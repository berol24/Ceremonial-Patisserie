...
//      Je voudrais un *${props.cake_quantite}* . Il m'en faudrait *${props.cake_quantite}* unités,
//      et le prix unitaire étant  à *${props.cake_prix_unitaire}* FCFA, ce qui fait un total de *${props.cake_prix_total}* FCFA.
                ...
                <section>
                  <div>
                    <div className="image-container">
                      ...
                      />
                      <label htmlFor="mtn">
                        <img src={image_MTN} alt="MTN" className="payment-image" />
                    ...
                    <div className="image-container">
                      ...
                      <label htmlFor="orange">
                        <img src={image_orange} alt="Orange Money" className="payment-image" />
                    ...
                    <div className="image-container">
                      ...
                      <label htmlFor="especes">
                        <img src={image_espece} alt="Espèces" className="payment-image" />
                        <span>Espèces</span>
                      </label>
                    </div>
                  </div>
